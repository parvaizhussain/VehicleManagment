...
{
    public class MaintainhistoryController : Controller
    {
        private readonly IVehicleCompanyRepository _vehicleCompanyRepository;
        private readonly IMemoryCache _memoryCache;
        private readonly ApplicationDbContext _db;

        public MaintainhistoryController(IVehicleCompanyRepository vehicleCompanyRepository, IMemoryCache memoryCache, ApplicationDbContext db)
        {
