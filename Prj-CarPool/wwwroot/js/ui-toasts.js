  ...
  if (toastPlacementBtn) {
    toastPlacementBtn.onclick = function () {
      if (toastPlacement) {
        ...
        var selectval = "top-0 end-0";
        selectedType = "text-success";// document.querySelector('#selectTypeOpt').value;
        selectedPlacement = selectval.split(' ');// document.querySelector('#selectPlacement').value.split(' ');
