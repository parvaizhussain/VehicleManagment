...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      var searchData = $.ajax({
        url: 'https://localhost:7010/navigation/MenuListForSearch', //assetsPath + 'json/' + searchJson, //? Use your own search api instead
            ...
            // Pages
            {
              ...
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Pages</h6>',
                  suggestion: function ({ controllerName, cssClass, name }) {
                  return (
                    '<a href="' +
                    controllerName +
                    '">' +
